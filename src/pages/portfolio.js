  ...
  const projects = [
    {
      name: "Space News",
      description:
        "Explore space through different endpoints and functionalities from multiple NASA API",
    ...
    {
      name: "TRVL",
      description: "Travel Advisor Application",
      details:
        "React - Google Maps API - Data Filtering - Rapid Places API - Material UI",
    ...
    },
    {
      name: "Dictionary",
      description:
        "Explore different features such as synonyms, audio pronunciation and related images",
    ...
    {
      name: "Yum Yum",
      description: "Basic Yelp App",
      details: "Intro to backend - PERN Stack - Deployed with Heroku",
      githubLink: "https://github.com/MarineauAndreanne/yumyum",
      netlifyLink: "https://marineau-andy-yumyum.herokuapp.com/",
      image: YumYum,
    },
    {
      name: "Read-it",
      ...
      netlifyLink: "https://read-it-five.vercel.app/",
      image: Reddit,
    },
    {
    ...
    },
    {
      ...
      details:
        "Firebase (Auth, Database) - Stripe Payments - The Movie Database API",
